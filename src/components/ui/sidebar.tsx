        ...
        return (
            ...
            >
                ...
                >
                    <div
                        data-sidebar="sidebar"
                        className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-active-500 group-data-[variant=floating]:shadow"
                    >
                        {children}
                    </div>
                </div>
...
>(({ className, ...props }, ref) => (
    <ul
        ...
        className={cn(
            'mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-r border-active-300 dark:border-active-900 px-2.5 py-0.5',
            'group-data-[collapsible=icon]:hidden',
            className,
        )}
        {...props}
